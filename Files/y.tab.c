...
{
       0,    44,    44,    56,    63,    72,    79,    88,    88,   118,
     118,   143,   159,   170,   186,   199,   209,   221,   240,   247,
     254,   263,   270,   277,   284,   294,   301,   310,   317,   324,
     331,   338,   345,   352,   359,   366,   373,   382,   389,   398,
     405,   414,   421,   430,   437,   446,   453,   462,   469,   478,
     485,   494,   501,   508,   517,   524,   531,   538,   545,   552,
     559,   568,   576,   584,   591
};
#endif
...
#line 144 "syntax_analyzer.y"
    {
			...
			symbol_info* param_symbol = new symbol_info((yyvsp[(4) - (4)])->getname(), "ID");
			param_symbol->set_data_type((yyvsp[(3) - (4)])->getname());
...
#line 171 "syntax_analyzer.y"
    {
			...
			// Insert parameter in current scope (will be function scope)  
			symbol_info* param_symbol = new symbol_info((yyvsp[(2) - (2)])->getname(), "ID");
			param_symbol->set_data_type((yyvsp[(1) - (2)])->getname());
			st->insert(param_symbol);
		}
    break;
...
#line 222 "syntax_analyzer.y"
    {
			...
			string var_type = (yyvsp[(1) - (3)])->getname();
